...
| WO-VB-4 | AVC/NORCECA/CSV/CAVB championships 2021–2025 | **IN-FLIGHT** (Asian M 2021+2023 built; next Asian W 2023 closes AVC) | 2/15 (97 rows) | census 03c280e, e5382dd, this | — |
...
**Store state:** 14 editions / 809 rows / ISSUES:0. Families CLOSED: EuroVolley (4/304), World_Championship (4/280), Olympics (4/128); Asian_Championship_M 2021+2023 in (WO-VB-4 running). Existence grid: `CALENDAR-MATRIX-VB-2026-08-23-AUD1.md` (update same-commit as any existence/built change).
