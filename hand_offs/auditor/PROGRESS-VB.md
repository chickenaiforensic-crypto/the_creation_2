...
| WO-VB-1 | EuroVolley M+W 2021, 2023 | **IN-FLIGHT** (W+M 2021 built; next W-2023, M-2023) | 2/4 (152 rows) | see log | — |
...
**Store state:** 2 editions / 152 rows / ISSUES:0 (EuroVolley_W 2021, EuroVolley_M 2021). Per-row sources = official CEV MatchStatistics URLs (www-old.cev.eu; wayback if offline) as cited in Wikipedia wikitext capture.
