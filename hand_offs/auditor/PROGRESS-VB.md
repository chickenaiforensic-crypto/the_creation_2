...
| WO-VB-1 | EuroVolley M+W 2021, 2023 | **IN-FLIGHT** (W-2021 built; next M-2021, W-2023, M-2023) | 1/4 (76 rows) | see log | — |
...
**Store state:** 1 edition / 76 rows / ISSUES:0 (EuroVolley_W 2021). Per-row sources = official CEV MatchStatistics URLs (www-old.cev.eu; wayback if offline) as cited in Wikipedia wikitext capture.
