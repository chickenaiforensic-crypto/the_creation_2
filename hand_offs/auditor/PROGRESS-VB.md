...
**Store state:** 12 editions / 712 rows / ISSUES:0. Families CLOSED: EuroVolley (4/304), World_Championship (4/280), Olympics (4/128). Existence grid: `CALENDAR-MATRIX-VB-2026-08-23-AUD1.md` (update same-commit as any existence/built change).
