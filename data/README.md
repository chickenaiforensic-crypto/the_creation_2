...
`data/Data_Sports/data/` is the production data tree (absolute path:
`data/Data_Sports/data/`). Store selection is controlled by
...
`data/Data_Sports/data/MANIFEST.json`, and resolves `active_store.path` relative to that
